...
`,N2=({message:e})=>g.jsx(P2,{children:g.jsx("p",{children:e})});function $2(e){return mt({tag:"svg",attr:{viewBox:"0 0 24 24"},child:[{tag:"path",attr:{fill:"none",d:"M0 0h24v24H0z"},child:[]},{tag:"path",attr:{d:"M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4-8 5-8-5V6l8 5 8-5v2z"},child:[]}]})(e)}const L2="/portafolio/assets/CV-Alejandro-Dt_xQf8M.pdf",T2=({handleVisibleEmail:e,isVisibleEmail:t})=>g.jsxs(E2,{children:[g.jsx("figure",{title:"Github",children:g.jsx("a",{href:"https://github.com/AlexNavDev",target:"_blank",rel:"noreferrer",children:g.jsx(s2,{})})}),g.jsx("figure",{title:"Linkedin",children:g.jsx("a",{href:"https://www.linkedin.com/in/alejandro-navarro-dev/",target:"_blank",rel:"noreferrer",children:g.jsx(u2,{})})}),g.jsx("figure",{title:"Correo electrónico",children:g.jsx("button",{onClick:e,"aria-label":"Mostrar dirección de correo electrónico",children:g.jsx($2,{})})}),g.jsx("figure",{title:"Curriculum Vitae",children:g.jsx("a",{href:L2,target:"_blank",rel:"noreferrer",children:g.jsx("img",{src:C2,alt:"logo CV",loading:"lazy"})})}),t&&g.jsx(N2,{message:"Email copiado al portapapeles"})]}),M2="/portafolio/assets/foto-BomFLIYo.png",Mu="data:image/svg+xml,%3csvg%20viewBox='0%200%20700%2068'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20clip-path='url(%23clip0_18_69)'%3e%3cpath%20d='M2.38419e-05%204.76837e-07L700%2058.6613V68H2.38419e-05V4.76837e-07Z'%20fill='%2309101a'/%3e%3c/g%3e%3c/svg%3e",R2=()=>{const[e,t]=oe.useState(!1),n=async()=>{try{await navigator.clipboard.writeText("navarro.alejandro@outlook.es"),t(!0)}catch(r){console.log(r)}};return oe.useEffect(()=>{const r=setTimeout(()=>{t(!1)},3e3);return()=>{clearInterval(r)}},[e]),{handleVisibleEmail:n,isVisibleEmail:e}},O2=({wrapperRef:e,cardRef:t})=>{oe.useEffect(()=>{const n=o=>{const l=e.current,a=t.current;if(a&&l){a.style.transition="none";const{width:s,height:c}=l.getBoundingClientRect(),h=s/2,m=c/2,{pageX:p,pageY:y}=o,w=(p-h)/h*10,k=(y-m)/m*10;a.style.transform=`rotateX(${w}deg) rotateY(${k}deg)`}},r=()=>{const o=t.current;o&&(o.style.transition="transform .5s ease-in-out",o.style.transform="rotateX(0deg) rotateY(0deg)")},i=e.current;return i&&(i.addEventListener("mousemove",n),i.addEventListener("mouseleave",r)),()=>{i&&(i.removeEventListener("mousemove",n),i.removeEventListener("mouseleave",r))}},[e,t])},I2=()=>{const{handleVisibleEmail:e,isVisibleEmail:t}=R2(),n=oe.useRef(null),r=oe.useRef(null);O2({wrapperRef:n,cardRef:r});const{handleGetName:i,currentElementId:o}=xd();return g.jsxs(k2,{id:"home",children:[g.jsx("div",{className:"wrapper",ref:n,children:g.jsxs("div",{className:"card",ref:r,children:[g.jsxs("h1",{children:[g.jsx("span",{children:"«¡"}),"Hola mundo",g.jsx("span",{children:"!»"})]}),g.jsxs("div",{className:"card__body",children:[g.jsxs("div",{className:"information",children:[g.jsxs("p",{children:["Mi nombre es ",g.jsx("span",{children:"Alejandro Navarro"})]}),g.jsx("p",{children:"Desarrollador Frontend"})]}),g.jsx("div",{className:"photo",children:g.jsx("figure",{children:g.jsx("img",{src:M2,alt:"Foto Alejandro"})})}),g.jsxs("button",{"aria-label":" Haz clic para ver los proyectos disponibles.",onClick:()=>i("projects"),children:[g.jsx("p",{className:`icon ${o=="section-projects"?"active":""}`}),"Ver Proyectos"]})]}),g.jsxs("div",{className:"card__footer",children:[g.jsx("img",{src:Mu,alt:"imagen-divisora"}),g.jsx("img",{src:Mu,alt:"imagen-divisora"})]})]})}),g.jsx(T2,{handleVisibleEmail:e,isVisibleEmail:t})]})},{secondary:D2,white:Ru}=Ft,F2=Te.div`
  position: relative;
  margin: 0 auto;
  display: flex;
  justify-content: space-around;
